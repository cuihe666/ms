...
// 对象处理的方法，针对查询组件, obj1是初始有值的对象，obj2是想要输出的对象，obj1和obj2的值要对应
export function objectHandle (obj1, obj2) {
  let objKeyArr1 = Object.keys(obj1);
  let objKeyArr2 = Object.keys(obj2);
  for (let i = 0; i < objKeyArr1.length; i++) {
    obj2[objKeyArr2[i]] = obj1[objKeyArr1[i]];
  }
  return obj2;
}
